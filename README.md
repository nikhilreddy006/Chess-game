...
1.Clone the repository: git clone https://github.com/nikhilreddy006/Chess-game.git
...
2.Player 1 and Player 2 will connect automatically.

3.Take turns moving pieces according to chess rules.

4.The game ends when a player is checkmated or a draw is declared.

# 📸 Screenshots

![image](https://github.com/user-attachments/assets/2f8c7c8c-dbc1-4941-be65-12dd702185e4)
